...
class LogController extends UtilBaseController
{
    ...
    public function autoLoginAction()
    {
        ...
        if (array_search($username, $autoLoginUsernames) === false ) {
            ...
            return $this->forward()->dispatch('Account/Controller/Log', array('action' => 'in'));
    ...
    public function inAction()
    {
        ...
        if($user !== false) {
            ...
            $this->flashMessenger()->addSuccessMessage(sprintf('Welcome %s. You are now logged in.',$user->getDisplayName()));
    ...
    {
        $fbtoken = $_SESSION['fbAccessToken'];
